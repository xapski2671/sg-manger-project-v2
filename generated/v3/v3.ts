...
export class v3CampaignAdded extends ethereum.Event {
  get params(): v3CampaignAdded__Params {
    return new v3CampaignAdded__Params(this);
  }
}

export class v3CampaignAdded__Params {
  _event: v3CampaignAdded;

  constructor(event: v3CampaignAdded) {
    this._event = event;
  }
...
export class v3CampaignFunded extends ethereum.Event {
  get params(): v3CampaignFunded__Params {
    return new v3CampaignFunded__Params(this);
  }
}

export class v3CampaignFunded__Params {
  _event: v3CampaignFunded;

  constructor(event: v3CampaignFunded) {
    this._event = event;
  }
...
export class v3CampaignRemoved extends ethereum.Event {
  get params(): v3CampaignRemoved__Params {
    return new v3CampaignRemoved__Params(this);
  }
}

export class v3CampaignRemoved__Params {
  _event: v3CampaignRemoved;

  constructor(event: v3CampaignRemoved) {
    this._event = event;
  }
...
export class v3CampaignShrunk extends ethereum.Event {
  get params(): v3CampaignShrunk__Params {
    return new v3CampaignShrunk__Params(this);
  }
}

export class v3CampaignShrunk__Params {
  _event: v3CampaignShrunk;

  constructor(event: v3CampaignShrunk) {
    this._event = event;
  }
...
export class v3UserAdded extends ethereum.Event {
  get params(): v3UserAdded__Params {
    return new v3UserAdded__Params(this);
  }
}

export class v3UserAdded__Params {
  _event: v3UserAdded;

  constructor(event: v3UserAdded) {
    this._event = event;
  }
...
export class v3 extends ethereum.SmartContract {
  static bind(address: Address): v3 {
    return new v3("v3", address);
  }
